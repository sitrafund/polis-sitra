#!/bin/bash
#
# This script applies the patches from the df-participation-patches folder to the df-participation repository.
# The export-df-participation-patches.sh script performs the reverse operation.
#
# Usage: `./scripts/apply-df-participation-patches.sh [df-participation]`
set -o errexit
